...
public class StrategyTest {
	...
	public void consoleTest() {
		...
		Logger templateMethodConsoleLogger = new ConsoleLogger();
	...
	public void fileTest() {
		...
		Logger templateMethodFileLogger = new FileLogger();
	...
	public void httpTest() {
		...
		Logger templateMethodHttpLogger = new HttpPostLogger();
		...
		for (String message : listener.getLogs()) {
			...
			assertTrue(
					"should contains the logger name '[Logger: FileLogger on "
							+ templateMethodFileLogger.getOutput() + "]'",
					message.contains("[Logger: FileLogger on "+ templateMethodFileLogger.getOutput() +"]"));
			assertTrue("should contains the log level ':ERROR:'", message.contains(":ERROR:"));
		}
	}
		...
		for (String message : listener.getLogs()) {
			...
			assertTrue(
					"should contains the logger name '[Logger: HttpPostLogger on "
							+ templateMethodHttpLogger.getOutput() + "]'",
					message.contains("[Logger: HttpPostLogger on "+ templateMethodHttpLogger.getOutput() +"]"));
